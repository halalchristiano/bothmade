...
import { DuplicatesBanner } from '@/components/admin/lead/DuplicatesBanner';
import { StepLabel } from '@/components/admin/lead/StepLabel';
...
export default function LeadDetailPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 md:py-10 overflow-x-hidden">
      ...
      <DuplicatesBanner leadId={leadId} duplicates={duplicates} />
