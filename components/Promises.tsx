...
const PROMISES = [
  ...
  },
  {
    ...
    // Worded against section 12 of the actual agreement, not past it: the
    // work built for you is assigned outright on final payment, and the few
    // pieces of our own toolkit that end up inside it carry a perpetual,
    // royalty-free licence. Saying "you own every line" would read better
    // and would not be true.
    body: 'The code and designs we build for you are assigned to you outright the moment the project is paid in full — no hostage situation, no "our platform" you can only leave by rebuilding. Anything we reuse from our own toolkit comes with a perpetual, royalty-free licence, so nothing you ship depends on staying our client. You can review it all on staging the whole way through, and walk away with it at the end.',
    proof: 'Assigned on final payment',
    href: '/start',
